...
import { AdapterContext as AdapterContextType, AdapterStatus as AdapterStatusType } from '@flopflip/types';

export default function useAdapterStatus(
): Error | AdapterStatusType {
  ...
  if (typeof React.useContext === 'function') {
     ...
     * has to remain.
     */
    const adapterContext: AdapterContextType = React.useContext(AdapterContext as any);
